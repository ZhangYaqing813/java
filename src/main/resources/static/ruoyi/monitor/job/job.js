	...
	var columns = [{
        ...
        },
        {
            ...
            formatter: function(value, row, index) {
				...
				actions.push('<a class="btn btn-primary btn-sm" href="#" title="编辑" mce_href="#" onclick="edit(\'' + row.jobId + '\')"><i class="fa fa-edit"></i></a>&nbsp;');
				actions.push('<a class="btn btn-warning btn-sm" href="#" title="删除" onclick="remove(\'' + row.jobId + '\')"><i class="fa fa-remove"></i></a>');
				return actions.join('');
            }
        }];
	var url = prefix + "/list";
...
function statusTools(row) {
    if (row.status == 1) {
        return '<a class="btn btn-primary btn-sm" href="#" title="启用" onclick="start(this,\'' + row.jobId + '\')"><i class="fa fa-check"></i></a>&nbsp;';
    } else {
    	return '<a class="btn btn-primary btn-sm" href="#" title="停用" onclick="stop(this,\'' + row.jobId + '\')"><i class="fa fa-minus"></i></a>&nbsp;';
    }
}
